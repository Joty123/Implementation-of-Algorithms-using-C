...
int main()
{
    ...
    printf("Please enter the values of your array in ascending or descending order below\n");
    ...
    while(lowerbound<=upperbound)                                                       // while loop works if the lower value of the array is less than or equal to the last value of the array
    {
        ...
        {
            printf("\n|%d\t|%d\t|%d\t|%d\t|%c\t|%c\t\t|%c\n", lowerbound, upperbound, middle, array[middle], datat, dataf,dataf);       // if the number is found then lower bound , upper bound , middle index, middle index value, data found
            printf("=================================================================");
        ...
        {
            printf("\n|%d\t|%d\t|%d\t|%d\t|%c\t|%c\t\t|%c\n", lowerbound, upperbound, middle, array[middle],dataf, datat,dataf);                         // print the lower bound , upper bound etc than is required.
            printf("-----------------------------------------------------------------");
        ...
        {                                                                                                          // if the middle is greater than the searching number then this loop will execute
            printf("\n|%d\t|%d\t|%d\t|%d\t|%c\t|%c\t\t|%c\n", lowerbound, upperbound, middle, array[middle], dataf, dataf,datat);        // printing the stuff
            printf("-----------------------------------------------------------------");
